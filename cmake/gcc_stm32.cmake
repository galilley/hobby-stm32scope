...
SET(STM32_SUPPORTED_FAMILIES L0 F0 F1 F2 F3 F4 F7 G4 CACHE INTERNAL "stm32 supported families")

IF(NOT TOOLCHAIN_PREFIX)
     SET(TOOLCHAIN_PREFIX "C:/Program Files (x86)/GNU Tools ARM Embedded/5.4 2016q3")
...
IF(NOT STM32_FAMILY)
    ...
    IF(NOT STM32_CHIP)
        SET(STM32_FAMILY "F0" CACHE INTERNAL "stm32 family")
...
FUNCTION(STM32_SET_TARGET_PROPERTIES TARGET)
    ...
    ENDIF()
    message("--> target ${TARGET} type ${STM32_CHIP_TYPE} chip ${STM32_CHIP}")
    IF((NOT STM32_FLASH_SIZE) OR (NOT STM32_RAM_SIZE))
        ...
        IF((NOT STM32_FLASH_SIZE) OR (NOT STM32_RAM_SIZE))
            message(${STM32_FLASH_SIZE})
            message(${STM32_RAM_SIZE})
